Shader "LightningStrikeEffect/URP/Lit_Transparent"
{
	Properties{
		[Header(BaseColor)]
		...
		SubShader{
			...
			Pass 
			{
				...
				half4 frag(Varyings IN) : SV_Target{
					...
					half metallic = SAMPLE_TEXTURE2D(_MetallicMap, sampler_MetallicMap, IN.uv).r * _MetallicIntensity;
					half3 emission = SAMPLE_TEXTURE2D(_EmissionMap, sampler_EmissionMap, IN.uv).rgb * _EmissionIntensity;
